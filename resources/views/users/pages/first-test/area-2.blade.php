...
<div class="w-full h-screen bg-mainHeader flex flex-col justify-center items-center font-montserrat">
  ...
  <div class="flex flex-col gap-y-10 justify-start items-center h-[calc(100vh-130px)] text-white font-bold w-full py-7 overflow-y-scroll relative z-20">
    ...
    <div class="w-[400px] flex flex-col gap-y-10 items-center justify-center">
      <img src="{{ asset('assets/test/first/vincent-art6.jpg') }}" alt="" class="w-[250px] phone:w-[300px] rounded-xl" draggable="false">
    ...
    <div class="w-[400px] flex flex-col gap-y-10 items-center justify-center mt-12">
      <img src="{{ asset('assets/test/first/pablo-art4.jpg') }}" alt="" class="w-[250px] phone:w-[300px] rounded-xl" draggable="false">
      <div class="flex justify-center w-full gap-x-8 phone:gap-x-20 text-black text-xs">
        <button class="bg-senimanBg h-[70px] w-[150px] phone:w-[300px] rounded-xl">VAN GOGH</button>
        <button class="bg-senimanBg h-[70px] w-[150px] phone:w-[300px] rounded-xl">PABLO PICASSO</button>
      </div>
    </div>

    <div class="w-[400px] flex flex-col gap-y-10 items-center justify-center mt-12">
      <img src="{{ asset('assets/test/first/raden-art4.jpg') }}" alt="" class="w-[250px] phone:w-[300px] rounded-xl" draggable="false">
      <div class="flex justify-center w-full gap-x-8 phone:gap-x-20 text-black text-xs">
    ...
    <div class="w-[400px] flex flex-col gap-y-10 items-center justify-center mt-12">
      <img src="{{ asset('assets/test/first/renaisans-1.jpg') }}" alt="" class="w-[250px] phone:w-[300px] rounded-xl" draggable="false">
      <div class="flex justify-center w-full gap-x-8 phone:gap-x-20 text-black text-xs">
    ...
    <div class="w-[400px] flex flex-col gap-y-10 items-center justify-center mt-12">
      <img src="{{ asset('assets/test/first/jackson-art2.jpg') }}" alt="" class="w-[250px] phone:w-[300px] rounded-xl" draggable="false">
      <div class="flex justify-center w-full gap-x-8 phone:gap-x-20 text-black text-xs">
        <button class="bg-senimanBg h-[70px] w-[150px] phone:w-[300px] rounded-xl">PABLO PICASSO</button>
        <button class="bg-senimanBg h-[70px] w-[150px] phone:w-[300px] rounded-xl">POLLOCK</button>
      </div>
    </div>
  </div>
