...
<div id="container" class="hidden">
  <div class="w-full flex items-center py-3 phone:py-0">
    ...
    <div class="w-full flex justify-end phone:justify-start">
      ...
      <audio id="audio" src="{{ asset('assets/audios/naturalisme/naturalisme-main.mp3') }}"></audio>
    </div>
  </div>
  ...
  <img src="{{ asset('assets/karakter/naturalis-char-rvs-m.png') }}" alt="" class="phone:hidden w-[280px] absolute right-0 bottom-0 -z-20" draggable="false">
  ...
  <div class="h-[calc(100vh-128px)] w-full hidden phone:flex justify-between items-center">
    ...
    <div>
      <img src="{{ asset('assets/karakter/naturalis-char-rvs.png') }}" alt="" class="w-[550px]">
    </div>
  </div>
    ...
    <div class="flex items-center justify-center w-full h-full">
      <div class="bg-bgNavbar/70 w-[800px] h-[400px] flex flex-col gap-y-5 items-center justify-center">
        ...
        <div>
          ...
          <audio id="audio2" src="{{ asset('assets/audios/naturalisme/naturalisme-record.mp3') }}"></audio>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="flex items-center justify-center w-full h-full">
      <div class="bg-bgNavbar/70 w-[800px] h-[420px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-10 h-[300px] font-lexend text-center text-lg">
          ...
          <p>Di abad ke-19, muncul Naturalisme sebagai gerakan seni yang terinspirasi dari Realisme, di mana mereka menggambar subjek kehidupan nyata tanpa idealisasi. Naturalisme lebih suka menggambarkan kehidupan di alam daripada di kota besar. Kata "naturalisme" sering digunakan dalam dua cara yang berbeda tapi terkait. Yang pertama, "naturalisme" dengan huruf kecil, digunakan secara luas untuk menggambarkan seni yang berusaha menampilkan realitas apa adanya. Konsep ini pertama kali dipopulerkan oleh kritikus Italia bernama Giovanni Pietro Bellori pada tahun 1672, ketika ia merujuk pada karya Caravaggio dan seniman lain yang terpengaruh olehnya, yang menekankan kebenaran hidup di atas keindahan konvensional. Di sisi lain, "Naturalisme" dengan huruf besar digunakan secara khusus untuk merujuk pada sastra dan seni pada abad ke-19. Istilah ini diciptakan pada tahun 1868 oleh penulis Perancis, Émile Zola.</p><br>
          <p>Pada tahun 1820-an, gaya prototipe Naturalisme sudah menjadi tren utama dalam lukisan pemandangan, terutama karena pengaruh seniman Inggris bernama John Constable. Selama periode ini, kelompok seniman dan perkumpulan mulai bermunculan di berbagai tempat di seluruh dunia, seperti Sekolah Norwich di Inggris timur, Sekolah Sungai Hudson di New York, dan Sekolah Barbizon di Perancis tengah sejak tahun 1830-an. Pengaruh mereka pun menyebar ke seluruh Eropa.</p>
        </div>
        <div>
      ...
      <div class="bg-bgNavbar/70 w-[800px] h-[400px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-16 h-[280px] font-lexend text-center text-lg flex flex-col gap-y-10">
          <div class="flex gap-x-5 items-center">
            ...
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">John Constable</h2>
              <p class="text-xl">Pelopor pendukung penggambaran alam yang realistis</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Théodore Rousseau</h2>
              <p class="text-xl">Pemimpin alami kelompok Barbizon</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p3.png') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Jean-Baptiste-Camille Corot</h2>
              <p class="text-xl">Mulai memproduksi lukisan lanskap saat berteman dengan pelukis-pelukis Sekolah Barbizon</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Rosa Bonheur</h2>
              <p class="text-xl">"Animalier" (pelukis hewan) Prancis terkemuka di usianya</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
      ...
      <div class="bg-bgNavbar/70 w-[800px] h-[400px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-16 h-[280px] font-lexend text-center text-lg flex flex-col gap-y-10">
          <div class="flex gap-x-5 items-center">
            ...
            <div class="w-3/5">
              <p class="font-bold text-2xl">The Hay Wain (1821)</p>
              <h2 class="text-xl">John Constable</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">View of the Forest of Fontainebleau (1830)</p>
              <h2 class="text-xl">Jean-Baptiste-Camille Corot</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p3.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">Under the Birches, Evening (1842-43)</p>
              <h2 class="text-xl">Théodore Rousseau</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">The Horse Fair (1855)</p>
              <h2 class="text-xl">Rosa Bonheur</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">Pemandangan di Sekitar Gunung Merapi (1900-1930)</p>
    ...
    <div class="flex items-center justify-center w-full h-full">
      <div class="bg-bgNavbar/70 w-full h-[500px] flex flex-col gap-y-5 items-center justify-center">
        ...
        <div>
          ...
          <audio id="audio2-m" src="{{ asset('assets/audios/naturalisme/naturalisme-record.mp3') }}"></audio>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="bg-bgNavbar/70  w-full h-[500px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-5 h-[400px] font-lexend text-center text-lg flex flex-col gap-y-5">
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p1.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">John Constable</h2>
              <p class="text-lg">Pelopor pendukung penggambaran alam yang realistis</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Théodore Rousseau</h2>
              <p class="text-lg">Pemimpin alami kelompok Barbizon</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p3.png') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Jean-Baptiste-Camille Corot</h2>
              <p class="text-lg">Mulai memproduksi lukisan lanskap saat berteman dengan pelukis-pelukis Sekolah Barbizon</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Rosa Bonheur</h2>
              <p class="text-lg">"Animalier" (pelukis hewan) Prancis terkemuka di usianya</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
      ...
      <div class="bg-bgNavbar/70 w-full h-[500px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-5 h-[400px] font-lexend text-center text-lg flex flex-col gap-y-5">
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p1.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">The Hay Wain (1821)</p>
              <h2 class="text-base">John Constable</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">View of the Forest of Fontainebleau (1830)</p>
              <h2 class="text-base">Jean-Baptiste-Camille Corot</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p3.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">Under the Birches, Evening (1842-43)</p>
              <h2 class="text-base">Théodore Rousseau</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">The Horse Fair (1855)</p>
              <h2 class="text-base">Rosa Bonheur</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/naturalisme/naturalisme2-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">Pemandangan di Sekitar Gunung Merapi (1900-1930)</p>
