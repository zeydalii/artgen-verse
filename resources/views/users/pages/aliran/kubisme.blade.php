...
<div id="container" class="hidden">
  ...
  <img src="{{ asset('assets/karakter/kubisme.png') }}" alt="" class="phone:hidden w-[170px] absolute right-0 bottom-10 -z-20" draggable="false">
  ...
  <div class="h-[calc(100vh-128px)] w-full hidden phone:flex justify-between items-center">
    ...
    <div>
      <img src="{{ asset('assets/karakter/kubisme.png') }}" alt="" class="w-[250px]">
    </div>
  </div>
