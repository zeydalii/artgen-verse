...
<div id="container" class="hidden">
  <div class="w-full flex items-center py-3 phone:py-0">
    ...
    <div class="w-full flex justify-end phone:justify-start">
      ...
      <audio id="audio" src="{{ asset('assets/audios/neo-klasik/neoklasik-main.mp3') }}"></audio>
    </div>
  </div>
    ...
    <div class="flex items-center justify-center w-full h-full">
      <div class="bg-bgNavbar/70 w-[800px] h-[400px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-black px-10 h-[280px] font-lexend text-start text-lg">
          ...
          <p class="bg-senimanBg font-bold p-5 rounded-xl shadow-aliran">Neoklasik suka menampilkan cerita-cerita tentang <span class="text-mainHeader text-xl font-extrabold">kebijaksanaan, pengetahuan, dan sejarah</span>. Jadi, ketika kalian melihat karya seni neoklasik. Kalian mungkin mendapat pelajaran sejarah atau moral yang mendalam!</p>
        </div>
        <div>
          ...
          <audio id="audio2" src="{{ asset('assets/audios/neo-klasik/neoklasik-record.mp3') }}"></audio>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="flex items-center justify-center w-full h-full">
      <div class="bg-bgNavbar/70 w-[800px] h-[420px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-10 h-[300px] font-lexend text-center text-lg">
          ...
          <p>Neoklasikisme itu sejenis gaya seni lukis yang mengikuti aturan-aturan dari Akademi Seni Kerajaan Prancis sejak tahun 1669. Mereka terinspirasi banget sama penemuan-penemuan keren dari zaman dulu di Yunani dan Romawi, yang waktu itu lagi jadi perbincangan di seluruh Eropa lewat gambar-gambar dari berbagai ekspedisi.</p><br>
          <p>Awalnya, Neoklasikisme ini mulai ngetren di Roma, khususnya setelah ada buku penting yang ditulis sama Johann Joachim Winckelmann pada tahun 1750, yang membahas tentang cara seniman-seniman dulu di Yunani bikin lukisan dan patung. Kedua seniman, Nicolas Poussin dan Claude Lorrain, dua orang yang banyak berkarya di Roma, dianggap sebagai teladan utama buat gaya Neoklasikisme. Poussin suka banget gambar tentang agama, mitologi, dan sejarah, sementara Claude lebih suka lukis pemandangan alam dengan detail yang sangat realistis dan perhatian khusus pada cahaya dan efeknya.</p><br>
          <p>Pokoknya, karya-karya mereka ini banyak banget menginspirasi gaya seni berikutnya, seperti Impresionisme dan Neo-Impresionisme, yang pada dasarnya ngebawa pesan tentang kebaikan dan keindahan ideal lewat lukisan-lukisan mereka.</p>
        </div>
        <div>
      ...
      <div class="bg-bgNavbar/70 w-[800px] h-[400px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-16 h-[280px] font-lexend text-center text-lg flex flex-col gap-y-10">
          <div class="flex gap-x-5 items-center">
            ...
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Claude Lorrain</h2>
              <p class="text-xl">karya-karyanya bercirikan klasisisme Barok dan salah satu inspirator berkembangnya Neoklasik</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Nicolas Poussin</h2>
              <p class="text-xl">Pendiri tradisi klasik Prancis salah satu inspirator berkembangnya Neoklasik</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p3.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Jacques-Louis David</h2>
              <p class="text-xl">Merupakan pelukis utama Neoklasik yang mengabdi pada monarki Louis XVI</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Jean-Auguste-Dominique Ingres</h2>
              <p class="text-xl">Salah satu siswa paling berbakat di studio Jacques Louis David</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-2xl">Angelica Kauffman</h2>
              <p class="text-xl">Karya-karyanya bercirikan potret perempuan-perempuan klasik</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-bgNavbar/70 w-[800px] h-[400px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-16 h-[280px] font-lexend text-center text-lg flex flex-col gap-y-10">
          <div class="flex gap-x-5 items-center">
            ...
            <div class="w-3/5">
              <p class="font-bold text-2xl">A landscape with Apollo guarding the herds of Admetus and Mercury stealing them (1645)</p>
              <h2 class="text-xl">Claude Lorrain</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">The Death of Germanicus (1627)</p>
              <h2 class="text-xl">Nicholas Poussin</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p3.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">The Death of Socrates (1787)</p>
              <h2 class="text-xl">Jacques-Louis David</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">Achilles Receiving the Ambassadors of Agamemnon (1801)</p>
              <h2 class="text-xl">Jean-Auguste-Dominique Ingres</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-2xl">Cornelia, Mother of the Gracchi, Pointing to her Children as Her Treasures (1785-an)</p>
              <h2 class="text-xl">Angelica Kauffman</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="flex items-center justify-center w-full h-full">
      <div class="bg-bgNavbar/70 w-full h-[500px] flex flex-col gap-y-5 items-center justify-center">
        ...
        <div>
          ...
          <audio id="audio2-m" src="{{ asset('assets/audios/neo-klasik/neoklasik-record.mp3') }}"></audio>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="bg-bgNavbar/70  w-full h-[500px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-5 h-[400px] font-lexend text-center text-lg flex flex-col gap-y-5">
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p1.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Claude Lorrain</h2>
              <p class="text-lg">karya-karyanya bercirikan klasisisme Barok dan salah satu inspirator berkembangnya Neoklasik</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Nicolas Poussin</h2>
              <p class="text-lg">Pendiri tradisi klasik Prancis salah satu inspirator berkembangnya Neoklasik</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p3.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Jacques-Louis David</h2>
          ...
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <h2 class="font-bold text-xl">Jean-Auguste-Dominique Ingres</h2>
              <p class="text-lg">Salah satu siswa paling berbakat di studio Jacques Louis David</p>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              ...
              <p class="text-lg">Karya-karyanya bercirikan potret perempuan-perempuan klasik</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-bgNavbar/70 w-full h-[500px] flex flex-col gap-y-5 items-center justify-center">
        <div class="overflow-y-auto text-white px-5 h-[400px] font-lexend text-center text-lg flex flex-col gap-y-5">
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p1.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">A landscape with Apollo guarding the herds of Admetus and Mercury stealing them (1645)</p>
              <h2 class="text-base">Claude Lorrain</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p2.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">The Death of Germanicus (1627)</p>
              <h2 class="text-base">Nicholas Poussin</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p3.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">The Death of Socrates (1787)</p>
              <h2 class="text-base">Jacques-Louis David</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p4.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">Achilles Receiving the Ambassadors of Agamemnon (1801)</p>
              <h2 class="text-base">Jean-Auguste-Dominique Ingres</h2>
            </div>
          </div>
          <div class="flex gap-x-5 items-center">
            <img src="{{ asset('assets/neoklasik/neoklasik2-p5.jpg') }}" alt="" class="w-2/5" draggable="false">
            <div class="w-3/5">
              <p class="font-bold text-lg">Cornelia, Mother of the Gracchi, Pointing to her Children as Her Treasures (1785-an)</p>
              <h2 class="text-base">Angelica Kauffman</h2>
            </div>
          </div>
        </div>
      </div>
