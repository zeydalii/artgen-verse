...
<div id="container" class="hidden">
  ...
  <img src="{{ asset('assets/karakter/romantisme-char-rvs-m.png') }}" alt="" class="phone:hidden w-[250px] absolute right-0 bottom-0 -z-20" draggable="false">
  ...
  <div class="h-[calc(100vh-128px)] w-full hidden phone:flex justify-between items-center">
    ...
    <div>
      <img src="{{ asset('assets/karakter/romantisme-char-rvs.png') }}" alt="" class="w-[550px]">
    </div>
  </div>
