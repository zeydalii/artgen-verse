...
<div id="container" class="hidden">
  ...
  <img src="{{ asset('assets/karakter/ekspresionisme.png') }}" alt="" class="phone:hidden w-[240px] absolute right-0 bottom-0 -z-20" draggable="false">
  ...
  <div class="h-[calc(100vh-128px)] w-full hidden phone:flex justify-between items-center">
    ...
    <div>
      <img src="{{ asset('assets/karakter/ekspresionisme.png') }}" alt="" class="w-[400px]">
    </div>
  </div>
