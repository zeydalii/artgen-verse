...
<div class="w-full h-screen flex justify-center items-center">
  <div class="bg-white py-20 px-28 flex flex-col gap-y-3 justify-center items-center">
    <h2 class="text-white bg-adminMain w-10 h-10 flex justify-center items-center font-extrabold rounded-2xl">ZA</h2>
    ...
    <div class="">
      <form action="/admin/login" method="POST" class="flex flex-col gap-y-4">
        ...
        <div class="flex flex-col text-sm gap-y-2">
          ...
          <input type="text" name="username" id="username" placeholder="Masukkan username" autocomplete="off" class="focus:outline-none border px-4 py-2 w-[250px] rounded-md" required>
        </div>
        <div class="flex flex-col text-sm gap-y-2">
