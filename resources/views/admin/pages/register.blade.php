  ...
  <div class="bg-white py-20 px-28 flex flex-col gap-y-3 justify-center items-center">
    ...
    <div class="">
      <form action="/admin/register" method="POST" class="flex flex-col">
        @csrf
        <div class="text-sm">
          <input type="text" name="username" id="username" placeholder="Masukkan username" autocomplete="off" class="focus:outline-none border border-b-0 rounded-b-none px-4 py-2 w-[250px] rounded-md" required>
        </div>
        <div class="text-sm">
